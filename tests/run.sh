...
"await_review:nitonly threads tworeviewers important untrailered"
"review_mode:sweeps mode refuses stopped submits unmarked silent skips stale midstop reaper timeout queue records status_count holds once rounds roundcap retries capped stubwrite"
