...
#
#   ./scripts/fleet/answer-review.sh "reworded the comment; the retry already backs off"
#   ./scripts/fleet/answer-review.sh --stdin  <notes.md
#
...
# is one full test run: tens of minutes, which is exactly what the working
# agreement's loop
...
# the last thread.
fleet_reask_gate "$head" "the review is answered"
